...
|Source Control URL|<p>This is the URL we built from above.  Be sure to fill it in to meet your personal student id, don't simply copy/paste!<p></p><p>Copy and paste the following, but replace the *TWO #* with your student number https://student#-git.network.workshop.ciqlab.dev/student#/ciq-basics.git</p></p><p></p><p>For student1, this would look like https://student1-git.network.workshop.ciqlab.dev/student1/ciq-basics.git</p>|
