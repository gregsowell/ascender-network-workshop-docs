<a name="_3t4zuh3r1m6r"></a>Basics 1.5 - Resource Modules
...
## <a name="_rk6lqn7a8fqj"></a>Create Resource Module Playbook
...
[insert screenshot of copy/paste of file]

Replace

I’ll now rename the snmp-config copy.yml file to snmp-resource.yml by right clicking it and choosing rename:
...
## <a name="_wmv8pai8lajq"></a>Copy A Job Template
